...
public class ConductBuffer 
{
	...
	private BaseUnit admin=new BaseUnit();
	...
	public BackUnit ValueDeal(BaseUnit base)
	{
		...
		else if(back.option.equals("admin"))
		{
			return admin(back,base);
		}
	...
	private BackUnit admin(BackUnit back,BaseUnit Base)
	{
		if(base.Username.equals(admin.Username)&&base.Password.equals(admin.Password))
		{
			back.check=true;
		}
		else
